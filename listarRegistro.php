            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    <div class="form-group has-search">
                        <label for="pesquisa_data_inicio"
                            style="font-family: 'Segoe UI Light',sans-serif;margin-left: 30%" class="text-black">Data
                            Inicial:</label>
                        <input type="date" name="pesquisa_data_inicio" style="font-family: 'Segoe UI Light',sans-serif"
                            id="pesquisa_data_inicio" class="form-control rounded-5 formedit placer">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group has-search">
                        <label for="pesquisa_data_fim" style="font-family: 'Segoe UI Light',sans-serif;margin-left: 30%"
                            class="text-black">Data Final:</label>
                        <input type="date" name="pesquisa_data_fim" style="font-family: 'Segoe UI Light',sans-serif"
                            id="pesquisa_data_fim" class="form-control rounded-5 formedit placer">
                    </div>
                </div>
                ...
                foreach ($listarRegistro as $registro) {
                    ...
                    <tr class="text-white" style="font-family: 'Segoe UI Light',sans-serif">
                        ...
                        <td>
                            ...
                            <div class="modal fade" style="background-color: #313348"
                                id="ModalVerMais<?php echo htmlspecialchars($idregistro); ?>" tabindex="-1"
                                        ...
                                        <div class="modal-body rounded-5" style="background-color: #252636">
                                            <?php if ($fotoregistro != null): ?>
                                                <img style="margin-right: 25%;width: 100%"
                                                    ...
                                                    alt="<?php echo htmlspecialchars($idregistro); ?>"
                                                    title="<?php echo htmlspecialchars($idregistro); ?>">
                                            <?php else: ?>
                                                Sem Foto
                                            <?php endif; ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control formvermais rounded-5" id="id_regoistro"
                                                    name="id_regoistro" value="<?php echo htmlspecialchars($idregistro); ?>"
                                                    disabled>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control formvermais rounded-5" id="data_registro"
                                                    name="data_registro" value="<?php echo htmlspecialchars($dataregistro); ?>"
                                                    disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label for="nome_usuario" class="form-label">Nome do Usuário</label>
                                                <input type="text" class="form-control formvermais rounded-5" id="nome_usuario"
                                                    name="nome_usuario" value="<?php echo htmlspecialchars($nomeusuario); ?>"
                                                    disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label for="cpf_usuario" class="form-label">CPF do Usuário</label>
                                                <input type="text" class="form-control formvermais rounded-5" id="cpf_usuario"
                                                    name="cpf_usuario" value="<?php echo htmlspecialchars($cpfusuario); ?>"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
    ...
    <nav aria-label="Navegação de páginas" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php if ($pagina_atual > 1): ?>
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $pagina_atual - 1; ?>&pesquisa_data_inicio=<?php echo urlencode($pesquisa_data_inicio); ?>&pesquisa_data_fim=<?php echo urlencode($pesquisa_data_fim); ?>&pesquisa_cpf=<?php echo urlencode($pesquisa_cpf); ?>&pesquisa_nome=<?php echo urlencode($pesquisa_nome); ?>"
                        aria-label="Anterior">
            ...
            <?php if ($pagina_atual > 6): ?>
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=1&pesquisa_data_inicio=<?php echo urlencode($pesquisa_data_inicio); ?>&pesquisa_data_fim=<?php echo urlencode($pesquisa_data_fim); ?>&pesquisa_cpf=<?php echo urlencode($pesquisa_cpf); ?>&pesquisa_nome=<?php echo urlencode($pesquisa_nome); ?>">1</a>
                </li>
            ...
            <?php for ($i = max(1, $pagina_atual - 5); $i <= min($pagina_atual + 5, $total_paginas); $i++): ?>
                <li class="page-item <?php if ($i == $pagina_atual)
                    echo 'active'; ?>">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $i; ?>&pesquisa_data_inicio=<?php echo urlencode($pesquisa_data_inicio); ?>&pesquisa_data_fim=<?php echo urlencode($pesquisa_data_fim); ?>&pesquisa_cpf=<?php echo urlencode($pesquisa_cpf); ?>&pesquisa_nome=<?php echo urlencode($pesquisa_nome); ?>"><?php echo $i; ?></a>
                </li>
            <?php endfor; ?>
            ...
            <?php if ($pagina_atual < $total_paginas - 5): ?>
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $total_paginas; ?>&pesquisa_data_inicio=<?php echo urlencode($pesquisa_data_inicio); ?>&pesquisa_data_fim=<?php echo urlencode($pesquisa_data_fim); ?>&pesquisa_cpf=<?php echo urlencode($pesquisa_cpf); ?>&pesquisa_nome=<?php echo urlencode($pesquisa_nome); ?>"><?php echo $total_paginas; ?></a>
                </li>
            <?php endif; ?>
