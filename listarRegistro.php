    ...
    <nav aria-label="Navegação de páginas" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php if ($pagina_atual > 1): ?>
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $pagina_atual - 1; ?>&pesquisa_data_inicio=<?php echo $pesquisa_data_inicio; ?>&pesquisa_data_fim=<?php echo $pesquisa_data_fim; ?>&pesquisa_cpf=<?php echo $pesquisa_cpf; ?>&pesquisa_nome=<?php echo $pesquisa_nome; ?>"
                        aria-label="Anterior">
            ...
            <?php if ($pagina_atual > 6): ?>
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=1&pesquisa_data_inicio=<?php echo $pesquisa_data_inicio; ?>&pesquisa_data_fim=<?php echo $pesquisa_data_fim; ?>&pesquisa_cpf=<?php echo $pesquisa_cpf; ?>&pesquisa_nome=<?php echo $pesquisa_nome; ?>">1</a>
                </li>
            ...
            <?php for ($i = max(1, $pagina_atual - 5); $i <= min($pagina_atual + 5, $total_paginas); $i++): ?>
                <li class="page-item <?php if ($i == $pagina_atual)
                    echo 'active'; ?>">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $i; ?>&pesquisa_data_inicio=<?php echo $pesquisa_data_inicio; ?>&pesquisa_data_fim=<?php echo $pesquisa_data_fim; ?>&pesquisa_cpf=<?php echo $pesquisa_cpf; ?>&pesquisa_nome=<?php echo $pesquisa_nome; ?>"><?php echo $i; ?></a>
                </li>
            <?php endfor; ?>
            ...
            <?php if ($pagina_atual < $total_paginas - 5): ?>
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="dashboard.php?page=registro&pagina=<?php echo $total_paginas; ?>&pesquisa_data_inicio=<?php echo $pesquisa_data_inicio; ?>&pesquisa_data_fim=<?php echo $pesquisa_data_fim; ?>&pesquisa_cpf=<?php echo $pesquisa_cpf; ?>&pesquisa_nome=<?php echo $pesquisa_nome; ?>"><?php echo $total_paginas; ?></a>
                </li>
            <?php endif; ?>
