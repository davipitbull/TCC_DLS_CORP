...
function listarUsuarios($campos, $tabela, $nome = '', $cpf = '')
{
    $conn = conectar();
    try {
...
$listarUsuario = listarUsuarios('idusuario, nomeUsuario, cpf, ativo, foto', 'usuario', $pesquisa_nome, $pesquisa_cpf);
?>
<!doctype html>
<html lang="pt-br">
                    ...
                    <tr class="text-white" style="font-family: 'Segoe UI Light',sans-serif">
                        ...
                        <td>
                            <?php if ($fotousuario != null) : ?>
                                <img src="data:<?php echo $tipoConteudo ?>;base64,<?php echo base64_encode($fotousuario) ?>" width="100" height="100" alt="<?php echo $idusuario ?>" title="<?php echo $idusuario ?>">
                            <?php else : ?>
                                Sem Foto
                            <?php endif; ?>
                        </td>
                        ...
                        <td>
                            ...
                            <button id="btnexc" onclick="abrirModalJsExcluir('<?php echo $idusuario ?>','id','ModalCerteza','A','excusuario','frmexcEnd');" class="Btngp mb-2 bg-danger">
                            ...
                            <div class="modal fade" style="background-color: #313348" id="ModalAlterar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body rounded-5" style="background-color: #252636">
                                            <form method="post" name="frmalterar" id="frmalterar">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control formedit placer rounded-5" id="nome_usuario" name="nome_usuario" placeholder="Seu Nome" autocomplete="off" required>
                                                </div>
                                                <div class="mb-4">
                                                    <label for="cpf_usuario" class="form-label">CPF</label>
                                                    <input autocomplete="off" type="text" onkeydown="fMasc(this, mCPF);" class="form-control cpf_usuario formedit placer rounded-5" id="cpf_usuario" name="cpf_usuario" maxlength="14" required placeholder="000.000.000-00">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="ativo_usuario" class="form-label">Status</label>
                                                    <select class="form-select formedit placer rounded-5" id="ativo_usuario" name="ativo_usuario" required>
                                                        <option value="A">Ativo</option>
                                                        <option value="D">Desativado</option>
                                                    </select>
                                                </div>
                                                <button type="submit" class="btn text-white mt-3 rounded-5" style="background-color: #3a3b4a;margin-left: 34%" id="saveChangesBtn">
                                                    Alterar no Banco
                                                </button>
                                            </form>
                                        </div>
                            ...
                            <button onclick="abrirModalJsVerMais('<?php echo $idusuario ?>','id','ModalVerMais<?php echo $idusuario ?>','A');" class="Btngp bg-warning">
                            ...
                            <div class="modal fade" style="background-color: #313348" id="ModalVerMais<?php echo $idusuario ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg rounded-5  modal-dialog-centered">
                                    <div class="modal-content rounded-5 ">
                                        <div class="modal-body rounded-5" style="background-color: #252636">
                                            <?php if ($fotousuario != null) : ?>
                                                <img style=";width: 100%;margin-right: 25%" src="data:<?php echo $tipoConteudo ?>;base64,<?php echo base64_encode($fotousuario) ?>" alt="<?php echo $idusuario ?>" title="<?php echo $idusuario ?>">
                                            <?php else : ?>
                                                Sem Foto
                                            <?php endif; ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control formvermais rounded-5" id="id_regoistro" name="id_regoistro" value="<?php echo $idusuario ?>" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label for="data_registro" class="form-label">Nome</label>
                                                <input type="text" class="form-control formvermais rounded-5" id="data_registro" name="data_registro" value="<?php echo $nomeusuario ?>" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <label for="data_registro" class="form-label">CPF</label>
                                                <input type="text" class="form-control formvermais rounded-5" id="data_registro" name="data_registro" value="<?php echo $cpfusuario ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
